...
export const SOURCE_IMG =
  'https://user-images.githubusercontent.com/66366941/223730922-7bf997f6-eb20-440e-92f7-6b5ad58f46ef.png';

export const EMOTION_JOY = 'joy';
export const EMOTION_SADNESS = 'sadness';
export const EMOTION_SURPRISE = 'surprise';
export const EMOTIONS = [EMOTION_JOY, EMOTION_SURPRISE, EMOTION_SADNESS];

/*

  connectaccount - 지갑 연결
  selectproject - project 선택
  selectnft - nft 선택
  checkout - 결제
  generate sticker - 스티커 생성
*/
